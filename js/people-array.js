...
const sortYoungestToOldest = (arr) =>
  arr.sort((a, b) => new Date(b.DOB) - new Date(a.DOB));
console.log(sortYoungestToOldest(people));

// 5) How many people are there in each department?
const peopleInEachDepartment = (arr) =>
  arr.reduce(
    (acc, person) => ({
      ...acc,
